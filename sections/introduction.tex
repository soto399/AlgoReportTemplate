La introducción de este tipo de informes o reportes, tiene como objetivo principal \textbf{contextualizar el problema que se va a analizar}, proporcionando al lector la información necesaria para entender la relevancia del mismo. En lugar de resolver un problema específico, los estudiantes deben enfocarse en estudiarlo desde diferentes perspectivas, realizar experimentos (implementaciones) y luego comparar los resultados obtenidos con lo que se espera desde un punto de vista teórico.
...
\textbf{La extensión máxima para la introducción para este informe es de 1 página.}
